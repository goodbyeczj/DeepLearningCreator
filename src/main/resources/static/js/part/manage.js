jQuery(function ($) {
    ...
    $('.ui.segments').on('click','.external.button',function () {
        ...
        $.ajax({
            url:'/model/projectName', async:false,
            type:'post',
            data:{id:id},
            // dataType:'json',
            beforeSend:function(jqXHR, settings){
        ...
        $.ajax({
            url:'/data/findDataSetByUserId', async:false,
            type:'get',
            dataType:'json',
            beforeSend:function(jqXHR, settings){
            },
        ...
        $.ajax({
            url:'/model/showData', async:false,
            type:'post',
            // data: {str:str},
            dataType:'json',
            beforeSend:function(jqXHR, settings){
